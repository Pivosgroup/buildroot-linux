...
#define AVIOCTL_INIT  			0x20001
#define AVIOCTL_START 			0x20002
#define AVIOCTL_STOP 			0x20003
#define AVIOCTL_RELEASE 	    0x20004

/*command fomat
url_ioctl(h,cmd,bufer_size,0);
*/
#define AVIOCTL_SET_BUF_SIZE 	0x20005
#define AVIOCTL_GET_BUF_SIZE 	0x20006
...
static inline int url_is_slowmedia(ByteIOContext *s)
{
