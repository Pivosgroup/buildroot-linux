...
static inline void do_rotate(image_t *i, int rot)
{
	if(rot)
	{
...
static inline void do_enlarge(image_t *i, int screen_width, int screen_height, int ignoreaspect)
{
...
static inline void do_fit_to_screen(image_t *i, int screen_width, int screen_height, int ignoreaspect, int cal)
{
	if((i->width > screen_width) || (i->height > screen_height))
	{
