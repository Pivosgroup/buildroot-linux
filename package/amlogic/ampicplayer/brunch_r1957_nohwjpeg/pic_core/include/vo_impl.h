...
typedef void (*display_pic_t)(void* arg,unsigned char *rgbbuff, unsigned char * alpha, int x_size, int y_size, int x_pan, int y_pan, int x_offs, int y_offs);
...
/* frame buffer. */
void fb_display(void* arg,unsigned char *rgbbuff, unsigned char * alpha, int x_size, int y_size, int x_pan, int y_pan, int x_offs, int y_offs);
void fb_getCurrentRes(int *x, int *y);

/* gles */
void*  gles_preinit(void* arg);
void gles_display(void* arg,unsigned char *rgbbuff, unsigned char * alpha, int x_size, int y_size, int x_pan, int y_pan, int x_offs, int y_offs);
