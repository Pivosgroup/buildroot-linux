...
#include <string.h>
#include "../nls_uni.h"
#include "../nls_iso8859-1.h"
#include "../nls_iso8859-2.h"
#include "../nls_iso8859-5.h"
#include "../nls_iso8859-7.h"
#include "../nls_iso8859-9.h"
#include "../nls_cp866.h"

#include "../nls_cp949.h"
#include "../nls_big5.h"
#include "../nls_gb2312.h"
...
int StrnGB2Unicode(char *dest_o, const char *src_o, int dest_len, int src_len)
{
	int src_index = 0, dest_index = 0;
        unsigned char * dest=(unsigned char *)dest_o;
        const unsigned char * src= (const unsigned char *)src_o;
