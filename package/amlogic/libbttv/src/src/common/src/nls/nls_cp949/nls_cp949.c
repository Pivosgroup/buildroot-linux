...
static u_int16_t c2u_A4[256] = {
	...
	0x3138,0x3139,0x313A,0x313B,0x313C,0x313D,0x313E,0xFFAF,/* 0xA8-0xAF */
	...
	0x3160,0x3161,0x3162,0x3163,0xFFA0,0x3165,0x3166,0x3167,/* 0xD0-0xD7 */
...
static u_int16_t *page_charset2uni[256] = {
...
static unsigned char u2c_00[512] = {
	...
	0x00, 0x00, 0xA1, 0xA9, 0x00, 0x00, 0x00, 0x00, /* 0xAC-0xAF */
...
static unsigned char u2c_11[512] = {
	0x00, 0x00, 0xA4, 0xA2, 0xA4, 0xA4, 0xA4, 0xA7, /* 0x00-0x03 */
	...
	0xA4, 0xB7, 0xA4, 0xF2, 0x00, 0x00, 0x00, 0x00, /* 0xF0-0xF3 */
...
static unsigned char u2c_31[512] = {
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* 0x2C-0x2F */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* 0x30-0x33 */
	0xA4, 0xA4, 0x00, 0x00, 0x00, 0x00, 0xA4, 0xA7, /* 0x34-0x37 */
...
static u_int16_t uni2char(u_int16_t unicode)
{
	...
	unsigned char cl = unicode&0xFF;
	unsigned char ch = (unicode>>8)&0xFF;
    u_int16_t ret = 0;
	

	uni2charset = page_uni2charset[ch];
	if (uni2charset) {
		ret    = uni2charset[cl*2];
		ret    = (uni2charset[cl*2+1])|(ret<<8);
...
struct nls_table nls_table_cp949 = {
	"cp949",
	UNICODE_TWO_BYTES,
	uni2char,
	char2uni,
